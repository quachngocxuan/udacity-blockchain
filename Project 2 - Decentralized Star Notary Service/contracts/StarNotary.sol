...
contract StarNotary is ERC721 {
    ...
    string public constant name = "FX Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        if (owner1Address != owner2Address) { // Do not allow exchange for yourself 
            if (owner1Address == msg.sender) {
                _transferFrom(msg.sender, owner2Address, _tokenId1);
                _transferFrom(owner2Address, msg.sender, _tokenId2);
            } else {
                _transferFrom(msg.sender, owner1Address, _tokenId2);
                _transferFrom(owner1Address, msg.sender, _tokenId1);
            }
        }
    }
