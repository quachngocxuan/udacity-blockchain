...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(await instance.name.call(), "FX Token")
    assert.equal(await instance.symbol.call(), "FXB")
});
...
it('lets 2 users exchange stars', async() => {
    ...
    let tokenId1 = 7;
    let tokenId2 = 8;
    await instance.createStar('Star 7', tokenId1, {from: user1});
    await instance.createStar('Star 8', tokenId2, {from: user2});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    lookUpStarName = await instance.lookUptokenIdToStarInfo(tokenId, {from: user1})
